const recentBooks = [
  {
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/effective-engineer.png'),
  },
  {
    name: 'Built To Last',
    status: 'Borrowed Out',
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/built-to-last.png'),
  },
  {
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/the-lean-startup.png'),
  },
  {
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/effective-python.png'),
  },
  {
    name: 'Big Magic',
    status: 'Available',
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/big-magic.png'),
  },
];
const allBooks = [
  {
...
const carouselBooks = [
  {
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/large/big-magic.png'),
  },
  {
    key: 11,
    name: 'Built To Last',
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/large/built-to-last.png'),
  },
  {
    key: 12,
    name: 'Effective Python',
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/large/effective-python.png'),
  },
  {
    key: 13,
    name: 'The Lean Startup',
    ...
    users: 31,
    likes: 29,
    cover: require('@images/bookcovers/large/the-lean-startup.png'),
  },
  {
    key: 14,
    name: 'Effective Python',
...
const autoComplete = (inp, arr) => {
  ...
  inp.addEventListener('input', (e) => {
    ...
    for (let i = 0; i < arr.length; i++) {
      ...
      if (item.name.substr(0, val.length).toLocaleLowerCase() == val.toLocaleLowerCase()) {
        /*create a Li element for each matching element:*/
        let result = document.createElement('li');
        /*make the matching letters by adding a styled span:*/
        result.innerHTML = '<span>' + item.name.substr(0, val.length) + '</span>';
...
const closeAllLists = (elmnt) => {
  ...
  for (let i = 0; i < x.length; i++) {
    if (elmnt != x[i] && elmnt != document.getElementById('autocomplete-input')) {
...
const loadBookSection = (title, list) => {
  ...
  for (let i = 0; i < list.length; i++) {
    ...
    status.className = `status ${book.status.toLocaleLowerCase().replace(/ /g, '')}`;
    ...
    user_icon.src = require('@images/icons/user-count.svg');
    user_icon.alt = 'social-icon';
    likes_icon.classList.add('likes');
    likes_icon.src = require('@images/icons/heart.svg');
...
const loadCarouselItems = () => {
  ...
  for (let i = 0; i < carouselBooks.length; i++) {
    ...
    details_toggle.onclick = () => openBookDetails(`carousel-item${carouselItem.key}`);
    details_toggle.src = require('@images/icons/details-toggle.svg');
    details_toggle.alt = 'details-toggle';

    //create close detail
    let close_details = document.createElement('img');
    close_details.classList.add('close-details');
    close_details.onclick = () => closeBookDetails(`carousel-item${carouselItem.key}`);
    close_details.src = require('@images/icons/close-details.svg');
    close_details.alt = 'close-details';

    //create details
    let details = document.createElement('div');
    details.classList.add('details'); //changed to book-details
    details.onclick = () => closeBookDetails(`carousel-item${carouselItem.key}`);
    let status = document.createElement('p');
    status.className = `status ${carouselItem.status.toLocaleLowerCase().replace(/ /g, '')}`;
    ...
    let likes_icon = document.createElement('img');
    user_icon.classList.add('users');
    user_icon.src = require('@images/icons/users-count-light.svg');
    user_icon.alt = 'social-icon';
    likes_icon.classList.add('likes');
    likes_icon.src = require('@images/icons/heart-light.svg');
    likes_icon.alt = 'social-icon';
...
autoComplete(document.getElementById('autocomplete-input'), autoCompleteResults);
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  window.closeBookDetails = function (id) {
    let carouselItem = document.getElementById(id);
    carouselItem.classList.remove('active');
  };
  ...
  window.handleChange = function (value) {
    handleChange(value);
  };
  window.loadCarouselItems = function () {
    loadCarouselItems();
  };
});
